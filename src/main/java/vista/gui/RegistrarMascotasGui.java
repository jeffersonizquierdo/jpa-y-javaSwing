...
public class RegistrarMascotasGui extends JDialog implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==btnRegistrar) {
			...
			mipersona = miCoordinador.ConsultarPersona(Long.parseLong(txtIdDueno.getText()));
			...
			String resul=miCoordinador.Registrarmascotas(miMascota);
			if(resul.equals("ok")) {
				JOptionPane.showMessageDialog(null, "Registro Exitoso!");
			}else {
				JOptionPane.showMessageDialog(null, "Fallo el registro! ** Compruebe si la persona a la que le asigna esta mascota existe");
			}
