...
import com.jefferson.aplicacion.Coordinador;
...
public class RegistrarPersonasGui extends JFrame implements ActionListener{
	...
	private controlador.Coordinador miCoordinador;
	...
	public void setCoordinador(controlador.Coordinador miCoordinador) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==btnAgregarMascotas) {
			...
			String registro = miCoordinador.registrarPersona(miPersona);
